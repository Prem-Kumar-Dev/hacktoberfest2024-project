/*ins_srt: Handles sorting small segments with insertion sort.

mrg: Merges sorted segments into larger sorted segments.

tim_srt: Orchestrates the Timsort process, starting with insertion sort on small segments and then merging sorted segments.

prt_arr: Utility to print the array.

main: Example usage of Timsort.
*/
#include <stdio.h>
#include <stdlib.h>
//Optimization
